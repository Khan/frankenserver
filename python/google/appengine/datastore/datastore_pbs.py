...
class _EntityConverter(object):
  ...
  def v1_to_v3_reference(self, v1_key, v3_ref):
    ...
    if not v3_ref.has_app():
      ...
      v3_ref.set_app(os.environ.get('APPLICATION_ID'))
  ...
  def v1_to_v3_entity(self, v1_entity, v3_entity, is_projection=False):
    ...
    for property_name, v1_value in v1_entity.properties.iteritems():
      ...
      if v1_value.HasField('array_value'):
        ...
        indexed = not v1_value.exclude_from_indexes
        if v1_value.WhichOneof('value_type') == 'entity_value':
          # HACK(benkraft): GAE doesn't allow embedded entities to be indexed,
          # whereas REST does.  We just set them unindexed, and hope that's
          # good enough.
          indexed = False
