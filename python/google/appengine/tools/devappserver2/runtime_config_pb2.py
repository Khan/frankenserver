...
_PYTHONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='grpc_proxy_port', full_name='apphosting.tools.devappserver2.PythonConfig.grpc_proxy_port', index=2,
