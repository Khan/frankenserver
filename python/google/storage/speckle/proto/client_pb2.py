...
_CLIENTCATEGORY = _descriptor.EnumDescriptor(
  name='ClientCategory',
  full_name='speckle.ClientCategory',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
      name='APP_ENGINE', index=0, number=1,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='COMPUTE_ENGINE', index=1, number=2,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MAESTRO', index=2, number=3,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
...
ClientCategory = enum_type_wrapper.EnumTypeWrapper(_CLIENTCATEGORY)
