...
_CLIENTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CLIENT_TYPE_PHP_MYSQLND', index=4, number=5,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
