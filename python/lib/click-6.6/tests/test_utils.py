...
import click
import click.utils
#import click._termui_impl  # Fails to import on App Engine
...
@pytest.mark.skip(reason="App Engine doesn't provide a tty")
...
@pytest.mark.xfail(raises=NotImplementedError,
                   reason="App Engine doesn't allow temporary folders")
...
@pytest.mark.skip(raises=NotImplementedError,
                  reason="App Engine doesn't allow temporary folders")
